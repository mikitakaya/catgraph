...
users = User.create!(
  [
    {email: "nagisa@n.com", name: "なぎさ", username: "nagi_gisa", introduction: "", password: "nagisapass", profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-user1.jpg"), filename:"sample-user1.jpg")},
